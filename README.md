...
어느 씬에서 테스트를 용이하게 하기 위해 BaseSceneManager 를 상속받는 컴포넌트가 씬에 하나라도 있으면 씬이 로드 된 후 전체적인 사전 비동기 초기화를 진행하고 이후 해당 SceneManager 의 OnInitAsync 구현을 통해 씬에서의 초기화 & 동작들을 수행 할 수 있습니다. 그리고 싱글톤으로 구현되어 씬마다 하나의 SceneManager 를 보장 받습니다.
